...
!IFNDEF JIT {
	...
	LDY	#$D8 ; leave an 8K buffer for JITted machine code SFTODO: shrink to 4K? 6K? might be nice to allow it to be user-selectable from command line
}
...
!IFDEF JIT {
	...
	STZ	JITCODEPTR
	LDA	#$D8	; SFTODO: CAN WE AVOID DUPLICATING THIS MAGIC CONST FROM ABOVE?
	STA	JITCODEPTR+1
}
	BRA	INITFP
	!CPU	6502
