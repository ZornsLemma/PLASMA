...
!IFDEF JIT {
	;* SFTODO: FOR NOW ON TUBE WE INITIALISE JITCODEPTR HERE, WHICH IS NOT NECESSARILY BAD BUT WE COULD DO IT IN CMD.PLA OR JIT.PLA - DOING IT HERE DOES SORT OF WORK NICELY, BECAUSE THIS IS THE CODE WHICH "KNOWS" WHAT WE ARE INITIALISING IFP/PP TO WITHOUT US HAVING TO DUPLICATE THAT INFORMATION
	STZ	JITCODEPTR
	LDA	#>TUBEJITHEAPTOP
	STA	JITCODEPTR+1
}
