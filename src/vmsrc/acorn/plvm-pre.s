...
;*
JITIINTERP
; SFTODONOW: MAKE SURE TO DIFF AGAINST APPLE II JIT VM TO PICK UP ANY JIT-RELATED CHANGES
        PLA
        STA     TMPL
        PLA
        STA     TMPH
...
!IFDEF PLAS128 {
; SFTODONOW: DIFF THIS AGAINST WHICHEVER APPLE II VM HAS THIS CODE AND CHECK FOR ANY IMPROVEMENTS THERE
...
;*
ENTER	
; SFTODONOW: THIS HAS BEEN TWEAKED (I THINK JUST OPTIMISED, BUT MAYBE IT'S FUNCTIONALLY DIFFERENT) ON APPLE II VM, NEED TO MERGE THAT
!IFDEF PLAS128 {
...
;* LEAVE FUNCTION
;*
; SFTODONOW: THIS MIGHT HAVE BEEN TWEAKED ON APPLE II VM, NOT SURE - NEED TO LOOK PROPERLY
LEAVE   INY                     ;+INC_IP
        LDA     (IP),Y
	CLC
	ADC	IFPL
