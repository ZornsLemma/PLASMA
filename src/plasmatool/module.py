...
class Module(object):
    ...
    def compact_int_symbol(i):
        ...
        # with one of these, so this guarantees our symbols are unique. TODO: BE GOOD TO VERIFY THOSE *ARE* THE RIGHT RESTRICTIONS COMPARED TO THE REAL PLASMA COMPILER
